...
// Helper — builds a clean open grid
static FRogueyGrid MakeGrid(int32 Width, int32 Height)
{
	FRogueyGrid Grid;
...
{
	FRogueyGrid Grid = MakeGrid(10, 10);
...
{
	FRogueyGrid Grid = MakeGrid(10, 5);
...
{
	FRogueyGrid Grid = MakeGrid(20, 20);
